        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                          placeholder="Mô tả nguồn gốc, tập tính, kích thước hoặc môi trường sống thích hợp..."
                          class="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 text-sm">{{ old('description') }}</textarea>
            </div>
            ...
            <div>
                ...
                <p class="text-[11px] text-slate-400 mt-1">Hỗ trợ ảnh định dạng: JPG, PNG, WEBP (Tối đa 2MB).</p>
            </div>
